                                                  ...
                                                  ConstProperties
{
    ...
    public static final class GetterSlot extends Slot
    {
        ...
        @Override
        public ScriptableObject getPropertyDescriptor(Context cx, Scriptable scope) {
            ...
            if (setter == null) {
                ...
                if (setter instanceof MemberBox) {
                    ...
                    f.call(cx, f.getParentScope(), start,
                           new Object[] { value });
                } else if (setter instanceof Callable) {
                    Callable f = (Callable)setter;
                    f.call(cx, start, start,
                           new Object[] { value });
                }
                return true;
            }
        ...
        public Object getValue(Scriptable start) {
            if (getter != null) {
                ...
                } else if (getter instanceof Callable) {
                    Callable f = (Callable)getter;
                    Context cx = Context.getContext();
                    return f.call(cx, start, start,
                                  ScriptRuntime.emptyArgs);
                }
            }
               ...
               InvocationTargetException
    {
        ...
        // "javascript". If so, then only methods that begin with special
        // prefixes will be defined as JavaScript tileentity.
